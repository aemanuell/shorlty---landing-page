export const InfoCardOne = {
    img: require('../../assets/icon-brand-recognition.svg').default,
...
export const InfoCardTwo = {
    img: require('../../assets/icon-detailed-records.svg').default,
...
export const InfoCardThree = {
    img: require('../../assets/icon-fully-customizable.svg').default,
